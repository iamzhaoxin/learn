...
#
#
# class M3206(scrapy.Spider):
#     # TODO 修改spider_name和start_urls
#     name = '3206'
#     start_urls = ['http://www.czmuseum.com/index']
#     custom_settings = {
...
#         # TODO 进入藏品目录页
#         for j in range(1, 25):
#             col_url = 'http://www.czmuseum.com/api/supreme/achieve_supreme_search?appkey=adi5c90nmp6xwpqw44&nonce=677910&timestamp=1620299999&pageSize=16&keyword=&type=&sign=1340840F50F3C99BBBBD3828FE7F1F5B&times=&terminal=1&page='+str(j)
#             col_id += 1000
