...
#         # TODO 进入藏品目录页
#         col_urls = ['http://www.sdmuseum.com/channels/ch00079/', 'http://www.sdmuseum.com/channels/ch00081/',
#                     'http://www.sdmuseum.com/channels/ch00083/', 'http://www.sdmuseum.com/channels/ch00099/',
#                     'http://www.sdmuseum.com/channels/ch00101/', 'http://www.sdmuseum.com/channels/ch00826/',
#                     'http://www.sdmuseum.com/channels/ch00827/']
...
#         # TODO 找不到进入详情页的路径
#         print(response.xpath('/html/body/div[3]/div[2]/table/tbody/tr/td/table/tbody/tr[4]/td/table/tbody//@href').extract())
#         col_lists = list(set(response.xpath('/html/body//tbody//tbody//@href').extract()))
#         print(col_lists)
#         for col_url in col_lists:
#             response.meta['col_id'] += 1
#             col_url = 'http://www.sdmuseum.com' + col_url
